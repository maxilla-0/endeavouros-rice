...
#define WIFI_ICON_EXCELLENT "󰤨 "
#define WIFI_ICON_GOOD      "󰤥 "
#define WIFI_ICON_FAIR      "󰤢 "
#define WIFI_ICON_POOR      "󰤟 "
	...
	wifi_perc(const char *interface)
	{
		...
		if (perc <= 25) {
			return WIFI_ICON_POOR;
		} else if (perc <= 50) {
			return WIFI_ICON_FAIR;
		} else if (perc <= 75) {
			return WIFI_ICON_GOOD;
		} else {
			return WIFI_ICON_EXCELLENT;
		}
	}
