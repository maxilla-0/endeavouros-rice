...
/* 31 FUCKING PATCHES APPLIED, VERY BLOATED DWM
 * alwaysontop
...
static const char *colors[][3] = {
	...
	[SchemeStatus]		= { "#83a598", "#1d2021",  "#000000" },
	[SchemeTagsSel]		= { "#fb4934", "#282828",  "#000000" },
	[SchemeTagsNorm]	= { "#fb4934", "#282828",  "#000000" },
	[SchemeInfoSel]		= { "#d3869b", "#282828",  "#000000" },//d3869b
	[SchemeInfoNorm]	= { "#282828", "#282828",  "#000000" },
	[SchemeLtSymbol]	= { "#d3869b", "#282828",  "#000000" },
	[SchemeStatusButton]	= { "#fbf1c7", "#1d2021",  "#000000" },
	[SchemeLauncher]	= { "#d3869b", "#1d2021",  "#000000" },
};
...
static const Block blocks[] = {
	...
	{ "#fbf1c7",	"/home/mandible/.local/bin/vol.sh",					2,		1},
	{ "#83a598",	"/home/mandible/.local/bin/rofi-scripts/ppr.txt",			2,		2},
	{ "#fb4934",	"date '+%A, %B %d, %Y, %I:%M:%S %p'",					1,		0},
};
...
//static const char* Launch10[]     = { "dwmc", "killclient", NULL };
...
static const char *upvol[] = { "sh", "-c", "pactl set-sink-volume @DEFAULT_SINK@ +2%;pkill -RTMIN+1 slstatus", NULL };
static const char *upvolalt[] = { "sh", "-c", "pactl set-sink-volume @DEFAULT_SINK@ +1%;pkill -RTMIN+1 slstatus", NULL };
static const char *downvol[] = { "sh", "-c", "pactl set-sink-volume @DEFAULT_SINK@ -2%;pkill -RTMIN+1 slstatus", NULL };
static const char *downvolalt[] = { "sh", "-c", "pactl set-sink-volume @DEFAULT_SINK@ -1%;pkill -RTMIN+1 slstatus", NULL };
static const char *mutevol[] = { "sh", "-c", "pactl set-sink-mute @DEFAULT_SINK@ toggle;pkill -RTMIN+1 slstatus", NULL };
static const char *brupcmd[] = { "brightnessctl", "set", "1%+", NULL };
static const char *brdowncmd[] = { "brightnessctl", "set", "1%-", NULL };
static const char *rofi[]     = { "rofi", "-show", "drun", "-show-icons", "-theme-str", "window {width: 70%;} inputbar {children: [prompt,entry,mode-switcher];}", NULL };
...
static const char *rofisearch[] = { "rofi", "-show", "search", "-modi", "search:/home/mandible/.local/bin/rofi-scripts/rofi-web-search.py", "-mesg", "Search with DuckDuckGo", "-theme-str", "inputbar {children: [prompt,entry];}", NULL };
static const char *rofishowwindow[] = { "rofi", "-show", "window", "-show-icons", "-theme-str", "window {width: 50%;} inputbar {children: [prompt,entry];}", NULL };
static const char *rofipowermenu[] = { "rofi", "-show", "Power Menu", "-theme-str", "window {width: 10%; x-offset: -12; border: 0px; border-radius: 0px;} inputbar {children: [prompt];}", "-modi", "Power Menu:/home/mandible/.local/bin/rofi-scripts/rofi-power-menu", "-location", "4", NULL };
static const char *ppr[] = { "rofi", "-show", "powerprofile", "-modes", "powerprofile:/home/mandible/.local/bin/rofi-scripts/ppr.sh", "-location", "3", "-theme-str", "window {width: 12.5%; border: 0px; border-radius: 0px; x-offset: -12; y-offset: 12px;} inputbar {enabled: false;} listview {lines: 3; columns: 1; padding: 0px 6px 6px 6px;}", "-hover-select", "-me-select-entry", "", "-me-accept-entry", "!MousePrimary", NULL };
...
static const char *layoutmenu[] = { "rofi", "-show", "layout-menu", "-modes", "layout-menu:/home/mandible/.local/bin/rofi-scripts/layoutmenu.sh", "-theme-str", "window {width: 12.3%; border: 0px; border-radius: 0px; x-offset: 294; y-offset: 48;} inputbar {enabled: false; children: [prompt];} listview {padding: 6px;}", "-hover-select", "-me-select-entry", "", "-me-accept-entry", "!MousePrimary", "-location", "1", NULL };
static const char *menu[] = { "rofi", "-show", "drun", "run", "filebrowser", "-modes", "drun,run,filebrowser", "-show-icons", "-location", "1", "-theme-str", "window {width: 35%; x-offset: 6; y-offset: 48; border: 0px; border-radius: 0px;} listview {lines: 12; columns: 1; scrollbar: true;} element-icon {size: 37px;} inputbar {children: [prompt,entry,mode-switcher];}", "-hover-select", "-me-select-entry", "", "-me-accept-entry", "!MousePrimary", NULL };
